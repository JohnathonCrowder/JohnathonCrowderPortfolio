  ...
  return (
    <section className="relative min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-7xl px-4 py-16 md:py-24">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-lg md:text-xl text-gray-400 mb-8 animate-fadeIn animation-delay-500">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                <a 
                  href="#projects" 
                  className="px-8 py-3 bg-blue-500 text-white font-semibold rounded-md transition duration-300 hover:bg-blue-600 hover:shadow-lg animate-fadeIn animation-delay-1000"
                >
                  View My Projects
                </a>
                <a 
                  href="#contact" 
                  className="px-8 py-3 bg-transparent text-blue-400 font-semibold rounded-md border-2 border-blue-400 transition duration-300 hover:bg-blue-400 hover:text-gray-900 hover:shadow-lg animate-fadeIn animation-delay-1000"
                >
                  Get In Touch
                </a>
              </div>
            ...
            <div className="w-full md:w-1/2 md:pl-8">
              <div className="code-container bg-gray-800 p-4 rounded-lg shadow-lg overflow-hidden">
